...
export function DarkMode() {
	...
	return (
		<button className={cn('aspect-square h-full')} onClick={toggleDarkMode}>
			<svg className={cn('group')} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
				{/*==================================================
					Sun
				==================================================*/}
				<path
					className={cn('block dark:hidden', pathClasses)}
					fill='#5757E0'
				...
				==================================================*/}
				<path
					className={cn('hidden dark:block', pathClasses)}
					fill='#5757E0'
