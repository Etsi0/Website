						...
						.map(
							(
								...
								<A
									...
									className='space-y-4 rounded-md bg-body-50 p-4 text-center dark:bg-body-200'
								>
									<div className='mx-auto inline-block aspect-square content-center'>
										<Image
											src={`/img/settings/vscode/${items.icon}`}
											alt=''
											width={
												128
											}
					...
					{JSON.stringify(
						{
							...
							'terminal.integrated.fontFamily':
								"'JetBrainsMono NFM', Consolas, 'Courier New', monospace",
